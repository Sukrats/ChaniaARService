...
public class PeriodsResource {
	...
	public Response getPeriods(@Context UriInfo uriInfo,
		...
		if(country != null && admin_area != null){
			System.out.print("Looking For Periods in: "+country+admin_area);
			per = PeriodService.getPeriodsForLocation(country, admin_area);
		}else{
			per = PeriodService.getAllPeriods();
		}
