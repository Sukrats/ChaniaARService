...
public class PeriodService {
	...
	public static ArrayList<Period> getPeriodsForLocation(String country, String admin_area){
		ArrayList<Period> PeriodsList = new ArrayList<Period>();
		Connection conn = null;
		Statement stmt = null;
		...
		try {
			...
			String query = " SELECT * FROM (( countries AS c "
					  ...
					  +" INNER JOIN level_has_periods AS lp ON lp.level_id = a.admin_area_id ) "
					  +" INNER JOIN period AS p ON lp.period_id = p.period_id "
			...
			{
				Period temp = new Period();
				temp.setId(rs.getLong("period_id"));
				temp.setName(rs.getString("name"));
				temp.setDescription(rs.getString("p.description"));
